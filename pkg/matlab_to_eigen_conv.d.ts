...
export function transpile_wrap(src: string, types: string, gen_mex_wrapper: boolean): TranspilerOutput;
...
export interface InitOutput {
    ...
    readonly transpile_wrap: (a: number, b: number, c: number, d: number, e: number) => number;
